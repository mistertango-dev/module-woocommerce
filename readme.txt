=== Mistertango for WooCommerce ===
Contributors: mnemotiv, mistertango
...
* Compatibility with manually created orders.
* Fix payment form amount formatting.
* Improved detailed logging.
* i18n/l10n: Moved translations to translate.wordpress.org.
* Initial phpDocs.
...
* Updated WordPress.org assets.
* Show different sign up and client support URLs depending on admin language.
* Added plugin support link for admin.
* Improved translations security.
* Updated some translations and original strings.
* Text domain must match the slug of the plugin.

= 3.1.2 =

Release Date: August 11th, 2017

* By default enable callback URL overwrite process.

= 3.1.1 =

Release Date: August 11th, 2017

* Compatibility with auto update.
